...
const FINISHES = [
  { suffix: 'Desert Storm', color: 0xc2a46b, metalness: 0.25, roughness: 0.7, rarity: 'consumer' },
  { suffix: 'Urban Mesh', color: 0x6a727a, metalness: 0.4, roughness: 0.55, rarity: 'consumer' },
  { suffix: 'Forest Canopy', color: 0x4a5c3a, metalness: 0.3, roughness: 0.65, rarity: 'consumer' },
  { suffix: 'Night Ops', color: 0x2a3038, metalness: 0.5, roughness: 0.45, rarity: 'industrial' },
  { suffix: 'Arctic White', color: 0xd8e2ea, metalness: 0.35, roughness: 0.4, rarity: 'industrial' },
  { suffix: 'Copper Patina', color: 0xb87333, metalness: 0.7, roughness: 0.35, rarity: 'industrial' },
  { suffix: 'Cobalt Stripe', color: 0x2f6fb5, metalness: 0.55, roughness: 0.4, rarity: 'milspec' },
  { suffix: 'Jade Current', color: 0x2f8f6b, metalness: 0.5, roughness: 0.38, rarity: 'milspec' },
  { suffix: 'Crimson Wake', color: 0xa83232, metalness: 0.55, roughness: 0.4, rarity: 'milspec' },
  { suffix: 'Neon Circuit', color: 0x1fd6c0, metalness: 0.65, roughness: 0.28, emissive: 0x0a4a44, rarity: 'restricted' },
  { suffix: 'Purple Haze', color: 0x6b3fa0, metalness: 0.6, roughness: 0.32, emissive: 0x2a1040, rarity: 'restricted' },
  { suffix: 'Solar Flare', color: 0xff8a1a, metalness: 0.55, roughness: 0.3, emissive: 0x4a2200, rarity: 'restricted' },
  { suffix: 'Void Carbon', color: 0x12161c, metalness: 0.85, roughness: 0.18, emissive: 0x102030, rarity: 'classified' },
  { suffix: 'Rose Titanium', color: 0xc45c7a, metalness: 0.8, roughness: 0.22, emissive: 0x401020, rarity: 'classified' },
  { suffix: 'Ion Storm', color: 0x3d7cff, metalness: 0.75, roughness: 0.2, emissive: 0x102040, rarity: 'classified' },
  { suffix: 'Blood Orbit', color: 0x8b0000, metalness: 0.7, roughness: 0.18, emissive: 0x400000, rarity: 'covert' },
  { suffix: 'Ghost Pearl', color: 0xe8f0ff, metalness: 0.9, roughness: 0.12, emissive: 0x304050, rarity: 'covert' },
  { suffix: 'Dragon Scale', color: 0x1a8f3c, metalness: 0.75, roughness: 0.2, emissive: 0x0a3018, rarity: 'covert' },
  { suffix: 'Apex Legend', color: 0xffd700, metalness: 0.95, roughness: 0.1, emissive: 0x5a4000, rarity: 'extraordinary' },
  { suffix: 'Black Market', color: 0xff3b5c, metalness: 0.9, roughness: 0.12, emissive: 0x400010, rarity: 'extraordinary' },
];
