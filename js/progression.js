...
export const MAPS = {
  ironfront: {
    ...
    blurb: 'Coastal docks, river cut, warhead sites A/B.',
    accent: '#e85d04',
    unlock: { type: 'default' },
    winsRequired: 0,
    theme: 'harbor',
  ...
  dustfall: {
    id: 'dustfall',
    name: 'Dustfall Mesa',
    blurb: 'Sun-baked canyons and a flooded wadi shipping lane.',
    accent: '#d4a017',
  ...
  frostbite: {
    ...
    blurb: 'Ice shelves, black water channels, arctic glare.',
    accent: '#7ec8e8',
  ...
  blacksite: {
    id: 'blacksite',
    name: 'Blacksite Yard',
    blurb: 'Night ops. Neon hangars and wet asphalt.',
    accent: '#ff3b7a',
    unlock: { type: 'wins', count: 12 },
    winsRequired: 12,
    theme: 'night',
  },
};
